            ...
            >
                  ...
                  <div onClick={(event) => event.stopPropagation()} className='w-[600px] max-w-full h-[400px] bg-white rounded-xl p-4 flex flex-col relative'>
                        ...
                        <p className='my-2'>
                              ...
                              Repellendus nesciunt, molestias dolor nisi sunt doloremque.
                              Odio aut dignissimos asperiores natus hic consectetur facere
                              necessitatibus et amet voluptas, quaerat, rem beatae.
                        </p>
